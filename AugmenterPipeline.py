...
class augmenter():
    def __init__(self, device: str = 'cuda'):
        ...
        self.pipe = StableDiffusionInpaintPipeline.from_pretrained("runwayml/stable-diffusion-inpainting", torch_dtype=weight_dtype)
    ...
    def _download_unet_model_weights(self,
                                model_path='unet',
                                public_key_unet='https://disk.yandex.ru/d/eAsvadK7VVvBDw',
                                public_key_text_encoder='https://disk.yandex.ru/d/ls4zQTZ5v1RcMg'):
    ...
    def _generate_prompt_llava_mistral(self,
        ...
        PROMPT2 = "USER: Imagine you are a painter who needs to describe an object to an apprentice in one sentence. "\
                  "Your task is to provide a concise, vivid, and detailed description "\
                  "using adjectives that convey the object's visual attributes such as its shape, size, color and texture. "\
                  "Finally, reveal the name of the object after the description. "\
                  f"Object to describe: {new_object}. ASSISTANT: "
